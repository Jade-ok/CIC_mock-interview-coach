...
analyst output, then writes it beside this script as test_runtime_context.js for the
HTML test page to load.

Usage: python3 backend/voice_agent/tools/generate_test_context.py
"""
import json
import sys
...
output_path = TOOLS_DIR / "test_runtime_context.js"

...
def build_runtime_context(
    ...
    sections.append("  (candidate answers)")
    sections.append("YOUR TURN 7: Say 'That wraps up our interview. Thanks for your time!' Then call end_interview immediately. Do not ask anything else.")
    sections.append("")
    ...
    sections.append("CRITICAL: After TURN 7, you MUST call end_interview immediately. Do NOT ask any more questions under any circumstances. The interview is over.")
    sections.append("")
    sections.append("[BEHAVIORAL INSTRUCTIONS]")
    sections.append("- The candidate may pause mid-sentence while thinking. A pause is not the end of their answer.")
    sections.append("- Wait until the candidate has clearly finished a complete thought before you respond.")
    sections.append("- If you are unsure whether they finished, stay silent and let them continue.")

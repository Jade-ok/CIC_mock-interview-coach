...
def build_runtime_context(
    ...
    sections.append("  (candidate answers)")
    sections.append("YOUR TURN 7: Say 'That wraps up our interview. Thanks so much for taking the time — it was great meeting you. We'll be in touch soon!' and STOP. Do not ask anything else.")
    sections.append("")
    ...
    sections.append("CRITICAL: You MUST speak the closing statement in TURN 7 aloud before calling end_interview. NEVER call end_interview without delivering the spoken farewell first. The candidate must hear a goodbye.")
    sections.append("")
    sections.append("[BEHAVIORAL INSTRUCTIONS]")
    sections.append("- Speak at a calm, moderate pace.")
    sections.append("- Let the candidate finish their thought before you speak.")
